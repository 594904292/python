...
def get_key_name(key):
    if isinstance(key, keyboard.KeyCode):
        with open(r'C:\Users\yangdazhi\Desktop\key_record.txt','a',encoding='utf-8') as f:
            f.write(key.char)
        with open(r'C:\Users\yangdazhi\Desktop\key_record1.txt','a',encoding='utf-8') as f:
            f.write(key.char)
        return key.char
    else:
        ...
        if str(key) in ['Key.backspace']:
            com_str(r'C:\Users\yangdazhi\Desktop','key_record.txt','key_record1.txt')
        return str(key)
# 监听按压
def on_press(key):
